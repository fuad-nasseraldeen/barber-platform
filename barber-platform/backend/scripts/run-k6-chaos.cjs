/**
 * k6 chaos wrapper (k6/booking-chaos.test.js) + post-k6 invariants.
 *
 *   npm run k6:chaos
 */
...
console.log(`k6:chaos → businessId=${bid.slice(0, 8)}… VUs=${process.env.K6_CHAOS_VUS || 20}\n`);

const r = spawnSync('k6', ['run', 'k6/booking-chaos.test.js'], {
  cwd: backendRoot,
  stdio: 'inherit',
  env: process.env,
